...
(custom-theme-set-faces 'an-old-hope
 ...
 '(font-lock-builtin-face ((t (:foreground "#0078D4"))))
 '(font-lock-comment-face ((t (:foreground "#cbccd1"))))
 '(font-lock-keyword-face ((t (:foreground "#ffffff"))))
 '(font-lock-constant-face ((t (:foreground "#0078D4" :inherit bold))))
 '(font-lock-function-name-face ((t (:foreground "#cbccd1"))))
 '(font-lock-negation-char-face ((t (:foreground "#0078D4"))))
 '(font-lock-preprocessor-face ((t (:foreground "#ffffff"))))
 '(font-lock-string-face ((t (:foreground "#0078D4"))))
 '(font-lock-doc-face ((t (:foreground "#cbccd1")))) ; TODO optional bg
 '(font-lock-type-face ((t (:foreground "#cbccd1"))))
 '(font-lock-variable-name-face ((t (:foreground "#cbccd1"))))
 '(font-lock-warning-face ((t (:background "#fedd38" :distant-foreground "#fedd38" :foreground "#1c1d20" :underline nil :inherit bold))))

 '(error ((t (:background "#f43333" :distant-foreground "#f43333" :foreground "#1c1d20" :inherit bold))))
 '(success ((t (:background "#78bd65" :distant-foreground "#78bd65" :foreground "#1c1d20" :inherit bold))))
 '(warning ((t (:background "#fedd38" :distant-foreground "#fedd38" :foreground "#1c1d20" :inherit bold))))
 ...
 '(header-line ((t (:background "#1c1d20" :foreground "#cbccd1"))))
 '(line-number ((t (:background "#212125" :foreground "#0078D4"))))
 '(line-number-current-line ((t (:foreground "#44464f" :inherit line-number))))
 '(vertical-border ((t (:foreground "#44464f"))))
 '(internal-border ((t (:foreground "#44464f" :background "#44464f"))))
 '(minibuffer-prompt ((t (:foreground "#0078D4" :weight bold))))

 '(highlight ((t (:foreground "#1c1d20" :background "#0078D4" :distant-foreground "#0078D4" :inherit bold))))
 ...
 '(isearch ((t (:background "#0078D4" :inherit bold))))
 ...
 '(rainbow-delimiters-depth-1-face ((t (:foreground "#0078D4"))))
 ...
 '(rainbow-delimiters-depth-5-face ((t (:foreground "#0078D4"))))
 ...
 '(link ((t (:foreground "#0078D4"))))
 '(link-visited ((t (:foreground "#f43333"))))

 ;;; modeline/spaceline
 '(mode-line ((t (:background "#0078D4" :foreground "#1c1d20" :box (:line-width 1 :color "##0078D4" :style none)))))
 ...
 '(spaceline-evil-emacs ((t (:inherit mode-line :foreground "#1c1d20" :background "#0078D4"))))
 ...
 '(spaceline-minibuffer ((t (:inherit mode-line :foreground "#1c1d20" :background "#0078D4"))))

 '(spaceline-flycheck-error ((t (:inherit bold :foreground "#f43333"))))
 '(spaceline-flycheck-warning ((t (:inherit bold :foreground "#fedd38"))))
 ...
 ;;; evil
 '(vimish-fold-overlay ((t (:background "#44464f" :foreground "#ea3d54"))))

 ;;; flycheck
 '(flycheck-info ((t (:underline (:style wave :color "#78bd65")))))
 '(flycheck-warning ((t (:underline (:style wave :color "#fedd38")))))
 '(flycheck-duplicate ((t (:underline (:style wave :color "#0078D4")))))
 ...
 ;;; flyspell
 '(flyspell-duplicate ((t (:foreground "#0078D4" :underline t))))
 ...
 '(company-preview-search ((t (:foreground "#0078D4" :weight normal :inherit company-preview))))
 ...
 '(company-tooltip-search ((t (:foreground "#0078D4" :inherit company-tooltip))))
 ...
 '(ahs-definition-face ((t (:background "#0078D4" :distant-foreground "#0078D4" :foreground "#44464f"))))
 ...
 '(ahs-plugin-whole-buffer-face ((t (:background "#0078D4" :distant-foreground "#78bd65" :foreground "#212125"))))
 '(ahs-plugin-bod-face ((t (:background "#5689f0" :distant-foreground "#5689f0" :foreground "#212125"))))
 '(ahs-plugin-defalt-face ((t (:background "#0078D4" :distant-foreground "#0078D4" :foreground "#212125"))))
 '(ahs-warning-face ((t (:foreground "#fedd38"))))

 ;;; compilation mode
 '(compilation-line-number ((t (:foreground "#0078D4"))))
 ...
 '(compilation-warning ((t (:foreground "#fedd38" :inherit bold))))
...
;;; org-mode
 '(org-link ((t (:foreground "#0078D4" :inherit bold))))
 '(org-footnote ((t (:foreground "#0078D4"))))
 ...
 '(org-warning ((t (:foreground "#fedd38" :inherit bold))))
 ...
 ;;; dashboard
 '(dashboard-text-banner ((t (:foreground "#0078D4"))))

 ;;; eshell-prompt-extras
 '(epe-remote-face ((t (:foreground "#0078D4"))))
 '(epe-venv-face ((t (:foreground "#b978ab"))))

 ;;; magit
 '(magit-mode-line-process-error ((t (:foreground "#f43333" :background "#cbccd1" :inherit bold))))
